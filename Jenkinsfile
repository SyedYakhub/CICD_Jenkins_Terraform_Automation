    ...
    stages {
        stage ('ssh connect + git checkout + terraform apply') {
            steps {
                ...
                sh "ssh -o StrictHostKeyChecking=no ec2-user@172.31.15.49 cd /var/lib/jenkins && git clone 'https://github.com/SyedYakhub/CICD_Jenkins_Terraform_Automation.git'"
